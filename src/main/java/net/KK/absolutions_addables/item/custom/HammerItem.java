...
public class HammerItem extends DiggerItem implements Vanishable {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        // Allow any enchantments applicable to either weapons or digging tools
        return enchantment.category == EnchantmentCategory.WEAPON || enchantment.category == EnchantmentCategory.DIGGER || super.canApplyAtEnchantingTable(stack, enchantment);
    }
